...
import { Event, EventType, EventStatus, BusinessUnit } from "@prisma/client"
import { z } from "zod"
...
const updateEventSchema = z.object({
  ...
  slug: z.string().min(1, "Slug is required").max(100, "Slug must be less than 100 characters")
    .regex(/^[a-z0-9-]+$/, "Slug must be lowercase letters, numbers, and hyphens only").optional(),
...
export default function EditEventPage({ params }: EditEventPageProps) {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const [eventResponse, businessUnitsResponse] = await Promise.all([
          axios.get(`/api/admin/cms/events/${id}`),
        ...
        setFormData({
          businessUnitId: eventData.businessUnitId,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Updating event:', validatedData)
      ...
      if (error instanceof z.ZodError) {
        ...
        setErrors({ general: error.response?.data?.error || 'Failed to update event' })
      }
    } finally {
      setIsLoading(false)
    }
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm font-medium text-foreground">Edit Event</span>
        </div>
      ...
      {updateSuccess && (
        <Alert className="border-emerald-200 bg-emerald-50">
          ...
          <AlertDescription className="text-emerald-800 font-medium">
            Event updated successfully! You will be redirected to the events list.
          </AlertDescription>
        </Alert>
      )}
          ...
          <div className="xl:col-span-2 space-y-8">
            ...
            <Card className="transition-all hover:shadow-md">
              <CardHeader className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Extra information about your event
                </p>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder="Casual, Formal, Semi-formal"
                    />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="ageRestriction" className="text-sm font-medium">
                      Age Restriction
                    </Label>
                    <Input
                      id="ageRestriction"
                      ...
                      placeholder="18+, Family-friendly, All ages"
                    />
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="transition-all hover:shadow-md">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch 
                    checked={formData.requiresBooking || false}
